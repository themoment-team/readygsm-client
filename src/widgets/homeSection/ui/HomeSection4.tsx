      ...
      >
        ...
        <div className={cn('flex flex-col gap-12 lg:pt-53 xl:flex-1 xl:pt-0')}>
          <div className={cn('flex flex-col gap-4')}>
            ...
            <h2
              className={cn(
                'text-neutral-dark text-[1.5rem] leading-[1.5] font-bold lg:text-[4rem]',
              )}
            >
              수상 경력
            </h2>
          ...
          <div className={cn('text-neutral-dark flex flex-col gap-6 font-bold')}>
            <p className={cn('text-[0.875rem] leading-[1.5] lg:text-[1.25rem]')}>
              실력은 결과로 증명합니다. GSM 학생들은 소프트웨어 분야 각종 대회에서 꾸준히 수상하며
              실력을 입증해 왔습니다. 제89회 전국기능경기대회 은상, 그리고 제47회
              국제기능올림픽대회(프랑스) 수상까지
            </p>
            <p className={cn('text-brand-primary text-[1rem] leading-[1.5] lg:text-[2rem]')}>
